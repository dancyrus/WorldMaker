...
| 2026-08-19 | Craton paint is stored per grid level (cell ids are level-specific): preset changes clear it; seed changes keep it, so painted continents ride along on a reroll. | default |
